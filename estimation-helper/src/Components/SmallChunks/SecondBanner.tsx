        ...
        <section className="bg-white w-[99%] p-10 my-2 mx-2 rounded-lg">
            ...
            <div className="container flex flex-col items-start  space-y-6 text-left">
                ...
                <div className="flex flex-col gap-2 min-[400px]:flex-row">
                    <a
                        href="#"
                        className="inline-flex h-10 items-center justify-center rounded-md bg-[#0E6ED6] px-8 text-md font-medium text-[#424242] shadow transition-colors hover:bg-primary/60 focus-visible:outline-none focus-visible:ring-1 focus-visible:ring-ring disabled:pointer-events-none disabled:opacity-50"
                    ...
                    <a
                        href="#"
                        className="inline-flex h-10 items-center justify-center rounded-md border border-primary-foreground bg-primary px-8 text-sm font-medium text-[#424242] shadow-sm transition-colors hover:bg-primary-foreground/90 hover:text-primary focus-visible:outline-none focus-visible:ring-1 focus-visible:ring-ring disabled:pointer-events-none disabled:opacity-50"
